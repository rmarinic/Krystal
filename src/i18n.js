...
(function () {
  ...
  const dict = {
    en: {
      ...
      'run.btn': 'Run',
      'run.stop': 'Stop',
      'run.btnTitle': 'Run this project locally to test it',
      'run.viewTitle': 'Running — click to watch the live output',
      'run.stopTitle': 'Stop the running app',
      'run.panelTitle': '▶ Run app',
      'run.close': 'Close',
      'run.setupTitle': 'How do we run this project?',
      'run.intro': 'Enter the command that starts this app locally for testing (it runs in the project folder). Some projects need a specific build/run command — set it once and the Run button will use it every time. Not sure? Let Claude work it out for you.',
      'run.cmdLabel': 'Run command',
      'run.cmdPlaceholder': 'e.g. npm run dev',
      'run.detect': '✨ Let Claude figure it out',
      'run.detecting': 'Claude is inspecting the project…',
      'run.detectFail': 'Couldn’t detect a run command — please enter one manually.',
      'run.detected': 'Claude suggested a command — review it, then Save & Run.',
      'run.needCmd': 'Enter a run command first.',
      'run.save': 'Save',
      'run.saveRun': 'Save & Run',
      'run.cancel': 'Cancel',
      'run.edit': '✎ Edit command',
      'run.restart': '↻ Restart',
      'run.stopBtn': '■ Stop',
      'run.starting': 'Starting…',
      'run.running': 'Running',
      'run.stopped': 'Stopped',
      'run.exited': 'Process exited (code {code}).',
      'run.exitedOk': 'Process finished cleanly.',
      'run.startFail': 'Could not start the app.',
      'run.waiting': 'Waiting for output…',
      'run.hintCmd': 'Runs in: {path}',
      ...
      'compact.btnTitleBusy': 'Compact once this reply finishes — it needs a settled chat',
      'clear.btn': '🗑 Clear',
      'clear.btnTitle': 'Start fresh: Claude forgets this chat',

      /* ---- branch (fork the conversation into a copy) ---- */
      'fork.btn': '🌿 Branch',
      'fork.working': '🌿 Branching…',
      'fork.btnTitle': 'Branch: fork this conversation into a copy you can take in a new direction — the original stays untouched',
      'fork.doneLabel': 'Branched',
      'fork.doneBody': 'You’re now on a copy of the chat. Take it wherever you like — the original is untouched.',
      'fork.doneBodyLive': 'You’re now on a copy of the chat. The reply still coming in stays in the original — this branch starts from everything before it.',
      'fork.emptyLabel': 'Nothing to branch yet',
      'fork.emptyBody': 'Send a message or two first, then branch to explore a different direction from here.',
      'fork.failLabel': 'Couldn’t branch',
      ...
      'meter.branched': 'branched chat <span class="cost">· continues from the copy · {win} window</span>',
      'meter.viewSummary': 'view summary',
      ...
      /* ---- agent inspector (one sub-agent's run) ---- */
      'agent.panelTitle': 'Sub-agent',
      'agent.close': 'Close',
      'agent.openTitle': 'Open this sub-agent: every step it takes, live',
      'agent.openBtn': 'Inspect',
      'agent.status.running': 'Working',
      'agent.status.done': 'Finished',
      'agent.status.error': 'Failed',
      'agent.status.stopped': 'Stopped',
      'agent.stat.tokens': 'tokens',
      'agent.stat.steps': 'steps',
      'agent.stat.elapsed': 'elapsed',
      'agent.stat.tool': 'last tool',
      'agent.launched': 'Launched',
      'agent.finishedLine': 'Finished',
      'agent.failedLine': 'Failed',
      'agent.stoppedLine': 'Stopped',
      'agent.reportLabel': 'Reported back',
      'agent.noReport': '(nothing reported)',
      'agent.waiting': 'Starting up… every step will show up here as it happens.',
      'agent.noHistory': 'The live steps aren’t kept once the app closes — this is the report the sub-agent handed back.',
      'agent.stopBtn': 'Stop',
      'agent.stopping': 'Stopping…',
      'agent.stopHint': 'A sub-agent can’t be stopped on its own — this ends the whole reply, this one with it.',
    ...
    hr: {
      ...
      'run.btn': 'Pokreni',
      'run.stop': 'Zaustavi',
      'run.btnTitle': 'Pokreni ovaj projekt lokalno za testiranje',
      'run.viewTitle': 'Radi — klikni za praćenje izlaza uživo',
      'run.stopTitle': 'Zaustavi pokrenutu aplikaciju',
      'run.panelTitle': '▶ Pokretanje',
      'run.close': 'Zatvori',
      'run.setupTitle': 'Kako pokrećemo ovaj projekt?',
      'run.intro': 'Unesi naredbu koja lokalno pokreće ovu aplikaciju za testiranje (izvršava se u mapi projekta). Neki projekti trebaju specifičnu naredbu za build/pokretanje — postavi je jednom i gumb Pokreni koristit će je svaki put. Nisi siguran/na? Neka Claude to smisli umjesto tebe.',
      'run.cmdLabel': 'Naredba za pokretanje',
      'run.cmdPlaceholder': 'npr. npm run dev',
      'run.detect': '✨ Neka Claude smisli',
      'run.detecting': 'Claude pregledava projekt…',
      'run.detectFail': 'Nije moguće otkriti naredbu — molimo unesi je ručno.',
      'run.detected': 'Claude je predložio naredbu — provjeri je pa Spremi i pokreni.',
      'run.needCmd': 'Prvo unesi naredbu za pokretanje.',
      'run.save': 'Spremi',
      'run.saveRun': 'Spremi i pokreni',
      'run.cancel': 'Odustani',
      'run.edit': '✎ Uredi naredbu',
      'run.restart': '↻ Ponovno pokreni',
      'run.stopBtn': '■ Zaustavi',
      'run.starting': 'Pokretanje…',
      'run.running': 'Radi',
      'run.stopped': 'Zaustavljeno',
      'run.exited': 'Proces završen (kôd {code}).',
      'run.exitedOk': 'Proces je uredno završio.',
      'run.startFail': 'Nije moguće pokrenuti aplikaciju.',
      'run.waiting': 'Čekanje na izlaz…',
      'run.hintCmd': 'Izvršava se u: {path}',
      ...
      'compact.btnTitleBusy': 'Sažimanje je moguće kad odgovor završi — potreban je smiren razgovor',
      'clear.btn': '🗑 Očisti',
      ...
      'fork.btn': '🌿 Grananje',
      'fork.working': '🌿 Granam…',
      'fork.btnTitle': 'Grananje: napravi kopiju ovog razgovora koju možeš povesti u novom smjeru — izvornik ostaje netaknut',
      'fork.doneLabel': 'Razgranano',
      'fork.doneBody': 'Sada si na kopiji razgovora. Povedi je kamo želiš — izvornik ostaje netaknut.',
      'fork.doneBodyLive': 'Sada si na kopiji razgovora. Odgovor koji još dolazi ostaje u izvorniku — ova grana počinje od svega prije njega.',
      'fork.emptyLabel': 'Još nema što granati',
      'fork.emptyBody': 'Prvo pošalji poruku ili dvije, a zatim granaj za istraživanje drugog smjera odavde.',
      'fork.failLabel': 'Grananje nije uspjelo',
      ...
      'meter.branched': 'razgranan razgovor <span class="cost">· nastavlja se iz kopije · prozor {win}</span>',
      'meter.viewSummary': 'prikaži sažetak',
      ...
      /* ---- nadzor agenta (jedan pod-agent) ---- */
      'agent.panelTitle': 'Pod-agent',
      'agent.close': 'Zatvori',
      'agent.openTitle': 'Otvori ovog pod-agenta: svaki korak, uživo',
      'agent.openBtn': 'Pregledaj',
      'agent.status.running': 'Radi',
      'agent.status.done': 'Završeno',
      'agent.status.error': 'Neuspjelo',
      'agent.status.stopped': 'Zaustavljeno',
      'agent.stat.tokens': 'tokena',
      'agent.stat.steps': 'koraka',
      'agent.stat.elapsed': 'proteklo',
      'agent.stat.tool': 'zadnji alat',
      'agent.launched': 'Pokrenut',
      'agent.finishedLine': 'Završio',
      'agent.failedLine': 'Neuspjeh',
      'agent.stoppedLine': 'Zaustavljen',
      'agent.reportLabel': 'Izvještaj',
      'agent.noReport': '(nema izvještaja)',
      'agent.waiting': 'Pokreće se… svaki korak pojavit će se ovdje dok se događa.',
      'agent.noHistory': 'Koraci uživo ne pamte se nakon zatvaranja aplikacije — ovo je izvještaj koji je pod-agent predao.',
      'agent.stopBtn': 'Zaustavi',
      'agent.stopping': 'Zaustavljam…',
      'agent.stopHint': 'Pod-agent se ne može zaustaviti sam — ovo prekida cijeli odgovor, a s njim i njega.',
